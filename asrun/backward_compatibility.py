...
def change_argv(oldargv):
    ...
    if dict_serv.get(arg1) is not None:
        ...
        warn(u"The service (%s) is not available any more. Update your ASTK client." % arg1,
    ...
    if rcdir is not None and not rcdir.startswith(".astkrc") and osp.abspath(rcdir) != rcdir:
        ...
        for i, v in enumerate(argv):
            if v.find("--rcdir=") > -1:
                ...
                warn(u"rcdir argument %s changed to %s" % (rcdir0, argv[i]),
