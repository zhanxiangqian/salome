   ...
   def sortieHTML(self,nomFichier):
            ...
            for ligne in fichierComm:
               ...
               if not finCommTrouvee:
                  ...
                  if len(tabDecoup) > 0:
                     ...
                     if self.__concepts.has_key(concept):
                        if curConcepts.has_key(concept):
            ...
            if nomComm == "FIN":
               ...
               for ligne in comm.fichier():
                  ...
                  if conceptsTrouves:
                     ...
                     if self.__concepts.has_key(nomCo):
      ...
      if self.__concepts != None:
         ...
         for concept in self.__concepts:
            ...
            typeCo = ""
            if typeConcepts.has_key(concept):
