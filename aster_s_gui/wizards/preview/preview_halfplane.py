...
dialogWithApply = fissdialog.FissDialogOnTopWithApplyHP()
dialogWithApply.setData(fissbuilder.DEFAULT_PFONX,
                        fissbuilder.DEFAULT_PFONY,
                        fissbuilder.DEFAULT_PFONZ,
                        fissbuilder.DEFAULT_NORMX,
                        fissbuilder.DEFAULT_NORMY,
                        fissbuilder.DEFAULT_NORMZ,
...
def acceptCallback():
    ...
    for i in range(len(LIST_SHAPE_NAME)) :
        if LIST_SHAPE_NAME[i] == DEFAULT_SHAPE_NAME:
            ...
            shape = fissbuilder.createGeometryHalfplane(activeStudy,PFONx, PFONy, PFONz, NORMx, NORMy, NORMz,DTANx,DTANy, DTANz )
            ...
            LIST = [ PFONx, PFONy, PFONz, NORMx, NORMy, NORMz,DTANx,DTANy, DTANz]
